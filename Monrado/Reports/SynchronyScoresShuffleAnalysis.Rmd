...
# NB list from 34 to 1 because the name of the first video is a numer and not a character
for (i in length(SSInoLogFilesList):1){
    print(i)
    #print (SSInoLogFilesList[i])
    SSIalone <- read.csv(SSInoLogFilesList[i])
    print(str(SSIalone))
    print(dim(SSIalone))
...
plot(SSI$SSI_pa_ch, type="l", lwd=2, ylim=c(0, 0.2), main="Scores of SSI natural data (in black) and 
