...
```{r}
write.table(slidedfather, "/Users/Ofix/Documents/Fac/internat/Recherche/projets/synchro/synchroData/slidedfather.txt", sep=",") 
write.table(slidedmother, "/Users/Ofix/Documents/Fac/internat/Recherche/projets/synchro/synchroData/slidedmother.txt", sep=",") 
write.table(slidedtherapist, "/Users/Ofix/Documents/Fac/internat/Recherche/projets/synchro/synchroData/slidedtherapist.txt", sep=",") 
write.table(slidedpatient, "/Users/Ofix/Documents/Fac/internat/Recherche/projets/synchro/synchroData/slidedpatient.txt", sep=",") 
```
...
par(mar=c(4,4,4,2))
plot(1:250, data$father[6:255], main="Mean motion history (Sliding 11 frames interval) 
     for father on F1044C video, 10 seconds, data therapist shifted", xlab="Frame index (25/s)", ylab="Momentum",
     col="blue", type="l", lty=2, lwd=0.5)
lines(slidedfather[1:250],  col="blue", lty=1)
lines(data$mother[6:255],  col="red", lty=2, lwd=0.5)
lines(slidedmother[1:250],  col="red", lty=1)
...
```{r, cache=FALSE}
plot (1:24, fatherEleven[1:24], type="l", col="blue", main="Mean Momentum (non overlapping 11 frames
      intervals) for father on F1044C video, first 10 seconds, data therapist shifted", ylab="Momentum", xlab="Frame index (each 11 frames)" )
lines(motherEleven[1:24], col="red", lty=1)
...
plot(1:250, data$father[256:505], main="Mean motion history (Sliding 11 frames
     ...
     data therapist shifted", xlab="Frame index (25/s)", ylab="Momentum", col="blue", type="l", lty=2, lwd=0.5)
lines(slidedfather[251:500],  col="blue", lty=1)
lines(data$mother[256:505],  col="red", lty=2, lwd=0.5)
lines(slidedmother[251:500],  col="red", lty=1)
lines(data$therapist[256:505],  col="orange", lty=2, lwd=0.5)
...
data therapist shifted", ylab="Momentum", xlab="Frame index (each 11 frames)", ylim=c(0, 0.009))
lines(motherEleven[23:46], col="red", lty=1)
...
length(fatherMinute)
  ...
  par(mar=c(4,4,4,2))
      ...
      ylab="Momentum", xlab="Time by Minute", ylim=c(0, 12E-03), 
