...
for (fam in famList){
      tab <- cbind(table(is.na(data[which(data$family==fam),]$father)),table(is.na(data[which(data$family==fam),]$mother)),table(is.na(data[which(data$family==fam),]$patient)), table(is.na(data[which(data$family==fam),]$therapist))) 
