...
SlidingInterval <- function(subject, indexOfvideos, interval, data){
  x <- c()
...
slidedfather <- SlidingInterval("father", 1:2 , 11, data)
str(slidedfather)

par(mar=c(4,4,4,2))
plot(1:250, data$father[251:500], main="Mean motion history (Sliding 11 frames interval) 
