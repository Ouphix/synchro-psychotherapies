...
data$norm.logTherapist[which(data$norm.logTherapist==-Inf)] <- 0
hist(data$norm.logTherapist)
str(data$norm.logTherapist)
sort(data$norm.logTherapist)
...
```{r  Log of motion history box plots by frame (raw data), all videos, echo=FALSE, cache=FALSE, eval =FALSE}
str(data)
